        ...
        <Box marginLeft={isTablet ? '0px' : '-11px'} width={isMobile ? '100%' : isTablet ? '90%' : '720px'} height={'auto'} backgroundColor={'#EBF7FF'} borderRadius={'10px'}>
            <Box display={'flex'} justifyContent={'space-between'} paddingLeft={'8px'} paddingTop={'8px'} paddingRight={'8px'}>
                ...
                <Link href={'/dashboard/courses'}>
                    <Button backgroundColor="#C3DDFD" borderRadius="8px" boxShadow="0 4px 12px rgba(0,0,0,0.1)" _hover={{ bg: 'white' }} fontSize='12px' fontWeight={'bold'}>View All</Button>
                </Link>
            </Box>
            {/* 1st Row */}
            <Box display={isMobile ? 'block' : 'flex'} flexWrap="wrap">
                {/* 1st Card */}
                <Box width={isMobile ? '100%' : '300px'} margin={isMobile ? '10px auto' : '0 15px 0 15px'}>
                    <Box backgroundColor={'white'} height={'140px'} display={'flex'} justifyContent={'space-between'}>
                ...
                {/* 2nd Row */}
                {/* 1st Card */}
                <Box width={isMobile ? '100%' : '300px'} margin={isMobile ? '10px auto' : '10px 15px'}>
                    <Box backgroundColor={'white'} height={'140px'} display={'flex'} justifyContent={'space-between'}>
                        <Box paddingTop={'10px'} paddingLeft={'20px'}>
